   ...
   const dbNameStyle2 = {
    ...
    return (
        <div style={cardStyle}>
            ...
            <div>
                {bahnCard.class == 1 && <h3 style={firstClass}>1.st Klasse</h3>}
            ...
            <div style={validityStyle}>
                GÜLTIG VOM {moment(bahnCard.validFrom).format('DD.MM.YYYY')} BIS <span style={bis}>{moment(bahnCard.validTo).format('DD.MM.YYYY')}</span>
            </div>
        </div>
    );
}
