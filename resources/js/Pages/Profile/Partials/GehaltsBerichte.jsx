...
export default function GehaltsBerichte({
    mustVerifyEmail,
    status,
    className = "",
}) {
    const user = usePage().props.auth.user;
    const salaryReport = usePage().props.salaryReport;
    useEffect(() => {
        ...
        <section className={className}>
            <header>
                ...
                <p className="mt-1 text-sm text-gray-600">
                    Hier können Sie Ihre Gehaltsabrechnungen einsehen und
                    herunterladen.
                </p>
            </header>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {salaryReport && salaryReport.length > 0 ? (
                        salaryReport.map((report, index) => (
                            <div
                                key={index}
                                className="bg-white p-4 rounded-lg shadow-md flex flex-col items-center border-2 border-gray-300"
                            >
