...
export default function ConfirmedToClient({ auth }) {
    ...
    const convertPDF = async () => {
        ...
        axios
            .post("/finalized-jobs/export-client-pdf", {
                user_id: filter.user,
    ...
    const filterAction = () => {
        ...
        setIsSubmitting(true);
        axios
            .post("/finalized-jobs/export-client", {
                user_id: filter.user,
                client_id: filter.client,
                week: filter.week,
                month: filter.month,
                ...
                <div className="flex justify-center flex-row p-5 mx-auto">
                    ...
                    <div className="max-w-md w-1/6 mx-5">
                        ...
                        >
                            ...
                            {filterSources.week &&
                                filterSources.week.map((week, index) => (
                        ...
                        {errors && errors.week && (
                            <p className="text-red-500">{errors.week}</p>
                        )}
                    </div>
                    <br />
                    <div className="max-w-md w-1/6 mx-5">
