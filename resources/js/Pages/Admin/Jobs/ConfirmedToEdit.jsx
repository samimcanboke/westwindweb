...
export default function ConfirmedToEdit({ auth }) {
    ...
    const getUnconfirmed = async () => {
        await axios.get("/data-confirmed-jobs").then((res) => {
            setData(res.data);
            setFilter(res.data);
            setLoading(false);
        ...
        >
            ...
            {data.length > 0 && (
                ...
                <input
                    ...
                    id="filter"
                    name="filter"
                    placeholder="Filtreleme kriteri girin..."
                    ...
                    onChange={(e) => {
                        ...
                        if (filterValue === "") {
                            ...
                            const filteredData = filter.filter((item) =>
                                item.tour_name.toLowerCase().includes(filterValue) ||
                                item.user_id.toString().includes(filterValue) ||
                                drivers.find((driver) => driver.id == item.user_id)?.name.toLowerCase().includes(filterValue)
                            );
